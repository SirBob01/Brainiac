...
//     hasher); Brainiac::Position pos(Brainiac::DEFAULT_BOARD_FEN, hasher);
//     Brainiac::Search bot;
...
//     std::cout << pos.fen() << "\n";
//     if (pos.is_checkmate()) {
//         std::cout << (pos.turn() == Brainiac::Color::White ? "Black" :
//         "White")
//                   << " wins!\n";
//     } else {
//         std::cout << "Draw!\n";
...
//     Brainiac::Position pos("r3k2r/1b4bq/8/8/8/8/7B/R3K2R w KQkq - 0 1");
//     pos.print();
//     Brainiac::History history;
//     Brainiac::Node node;

//     Brainiac::MovePicker picker;

//     picker.add(Brainiac::Move(Brainiac::Square::A2,
//                               Brainiac::Square::A4,
//                               Brainiac::MoveType::Quiet),
//                pos,
//                history,
//                node);
//     picker.add(Brainiac::Move(Brainiac::Square::A2,
//                               Brainiac::Square::A3,
//                               Brainiac::MoveType::Capture),
//                pos,
//                history,
//                node);
//     picker.add(Brainiac::Move(Brainiac::Square::B2,
//                               Brainiac::Square::B4,
//                               Brainiac::MoveType::Capture),
//                pos,
//                history,
...
//                history,
//                node);
//     // for (Brainiac::Move move : pos.moves()) {
//     //     picker.add(move, pos, history, node);
//     // }

//     Brainiac::MoveEntry entry;
//     unsigned i = 0;
//     while (!picker.end()) {
//         entry = picker.next();
//         i++;
//         std::cout << entry.move.standard_notation()
//                   << " Phase: " << int(entry.phase) << " " <<
//                   int(entry.value)
//                   << "\n";
//     }
//     std::cout << "Total moves: " << i << "\n";
//     return 0;
// }